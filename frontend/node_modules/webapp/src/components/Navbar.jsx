...
const Navbar = () => {
  ...
  const safeLogoUrl = (typeof logoUrl === 'string' && logoUrl.trim()) ? logoUrl : '/logo_.jpg';
  ...
  return (
    <>
      {navbarShow_condition ? (
        ...
        <header className="border-b border-slate-200/20 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white">
...
<span className="text-xl font-bold text-white tracking-wide">scholarshipopertunity</span>
              ...
              {/* Desktop Menu */}
              <ul className="hidden md:flex flex-1 justify-center space-x-4 items-center font-medium text-sm">
                ...
                <li className="relative">
                  ...
                  {openDropdown === "region" && (
                    <ul className="absolute left-0 mt-2 w-48 bg-white text-black rounded-md shadow-lg z-20" onMouseLeave={() => setOpenDropdown(null)}>
                      ...
                      <li><Link to="/russian-scholarship" className="block px-4 py-2 hover:bg-gray-100 text-sm" onClick={() => setOpenDropdown(null)}>Russian Scholarship</Link></li>
                    </ul>
                  )}
                </li>

                <li><Link to="/internship" className="hover:text-gray-300 transition-colors">Internship</Link></li>
                <li><Link to="/youtube-videos" className="hover:text-gray-300 transition-colors">YouTube</Link></li>
            ...
            {/* Mobile Menu */}
            {menuOpen && (
              <ul className="md:hidden mt-2 space-y-1 font-medium bg-slate-950 rounded-b-lg pb-4 text-sm">
                ...
                <li>
                  ...
                  {openDropdown === "mob_region" && (
                    <ul className="pl-6 space-y-1">
                      ...
                      <li><Link to="/russian-scholarship" className="block px-4 py-2 hover:bg-gray-800" onClick={() => setMenuOpen(false)}>Russian Scholarship</Link></li>
                    </ul>
                  )}
                </li>

                <li><Link to="/internship" className="block px-4 py-2 hover:bg-gray-800" onClick={() => setMenuOpen(false)}>Internship</Link></li>
                <li><Link to="/youtube-videos" className="block px-4 py-2 hover:bg-gray-800" onClick={() => setMenuOpen(false)}>YouTube</Link></li>
                <li><Link to="/blogs" className="block px-4 py-2 hover:bg-gray-800" onClick={() => setMenuOpen(false)}>Blogs</Link></li>
                <li className="px-4 py-2"><ThemeToggle /></li>
