...
import Russian_scholarship from './components/Russian_scholarship.jsx';
...
import Site_branding from './admin/Site_branding.jsx';
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/russian-scholarship' element={<Russian_scholarship />} />
        ...
        <Route path='/admin/delete_blog' element={<Mange_bloge/>}/>
         <Route path='/admin/site-branding' element={<Site_branding/>}/>
