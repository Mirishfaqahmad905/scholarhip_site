...
const Add_bloge = () => {
  ...
  const [imageUrls, setImageUrls] = useState(['']); // for external image URLs
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        {step === 2 && (
          <>
            ...
            {/* External Image URL Inputs */}
            <div className="mt-6">
              <h3 className="text-lg font-semibold mb-2">Image URLs (Optional)</h3>
          ...
          <div className="border p-6 rounded shadow bg-gray-50">
            ...
            <div className="space-y-4">
              ...
              {imageUrls.filter(url => url.trim() !== '').map((url, index) => (
                <img key={index} src={url} alt={`External ${index}`} className="w-full max-h-96 object-cover rounded" />
              ))}
            </div>
            <div className="flex justify-between mt-6">
